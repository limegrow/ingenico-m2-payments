...
class InstallSchema implements InstallSchemaInterface
{
    ...
    const PARAM_NAME_UNIQUE = 'unique';
    ...
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        if (!$installer->tableExists(self::PARAM_NAME_TABLE_NAME_TRANSACTION)) {
            $table = $installer->getConnection()
                ...
                ->addColumn(
                    ...
                    Table::TYPE_INTEGER,
                    null,
                    [self::PARAM_NAME_IDENTITY => true, self::PARAM_NAME_NULLABLE => false, self::PARAM_NAME_PRIMARY => true],
                    'ID'
                )
                ->addColumn(
                    ...
                    Table::TYPE_TEXT,
                    32,
                    [self::PARAM_NAME_NULLABLE => true, self::PARAM_NAME_DEFAULT => null],
        ...
        if (!$installer->tableExists(self::PARAM_NAME_TABLE_NAME_REMINDER)) {
            $table = $installer->getConnection()
                ...
                ->addIndex(
                    $installer->getIdxName(self::PARAM_NAME_TABLE_NAME_REMINDER, [self::PARAM_NAME_ORDER_ID,self::PARAM_NAME_SECURE_TOKEN]),
                    [self::PARAM_NAME_ORDER_ID,self::PARAM_NAME_SECURE_TOKEN],
                    ['type' => self::PARAM_NAME_UNIQUE]
                )
                ->setComment(
        ...
        if (!$installer->tableExists(self::PARAM_NAME_TABLE_NAME_ALIAS)) {
            $table = $installer->getConnection()
                ...
                ->addColumn(
                    ...
                    Table::TYPE_TIMESTAMP,
                    null,
                    [self::PARAM_NAME_NULLABLE => false, self::PARAM_NAME_DEFAULT => Table::TIMESTAMP_INIT]
                )
                ->addColumn(
                    'updated_at',
                    Table::TYPE_TIMESTAMP,
                    null,
                    [self::PARAM_NAME_NULLABLE => false, self::PARAM_NAME_DEFAULT => Table::TIMESTAMP_INIT_UPDATE]
                )
                ->addIndex(
                    $installer->getIdxName(self::PARAM_NAME_TABLE_NAME_ALIAS, [self::PARAM_NAME_CUSTOMER_ID,self::PARAM_NAME_ALIAS]),
                    [self::PARAM_NAME_CUSTOMER_ID,self::PARAM_NAME_ALIAS],
                    ['type' => self::PARAM_NAME_UNIQUE]
                )
                ->setComment(
